        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-serif font-bold text-slate-900 mb-6">
              ...
              <span className="block text-coral-peach">Born from Love</span>
            </h2>
            ...
            <div className="grid grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-3xl font-bold text-coral-peach mb-2">30+</div>
                <div className="text-sm text-slate-600">Years of Excellence</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-coral-peach mb-2">10k+</div>
                <div className="text-sm text-slate-600">Happy Customers</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-coral-peach mb-2">500+</div>
                <div className="text-sm text-slate-600">Unique Designs</div>
              </div>
            </div>
          </div>
          <div className="relative">
            <div className="aspect-square bg-pale-peach/20 rounded-lg overflow-hidden">
              <img 
                src="/placeholder.svg" 
            ...
            <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-coral-peach rounded-full flex items-center justify-center text-white font-serif font-bold text-2xl">
              V
            </div>
          </div>
        </div>
